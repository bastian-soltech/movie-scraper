...
const data = await fetch(`https://api.ytbvideoly.com/api/resconsume/hotlist?res_type=${type}&page=1&count=10&lang=ID&from_channel=11&hot_order_type=plays_pv&source_domain=layarkaca.id`,{
    headers: {
