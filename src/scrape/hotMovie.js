...
export async function GetHotMovie(type){
const data = await fetch(`https://api.ytbvideoly.com/api/resconsume/hotlist?res_type=${type}&page=1&count=10&lang=PH&from_channel=11&hot_order_type=plays_pv&source_domain=www.4khotvideo.com`,{
    headers: {
